...
public ArrayList<Product> showOneTypeProduct(int type){
	ArrayList<Product> list=new ArrayList<Product>();
	try{
...
public ArrayList<Product> showBySearch(String  search){
	ArrayList<Product> list=new ArrayList<Product>();
...
public ArrayList<Product> showallProductBySeald(){
	ArrayList<Product> list=new ArrayList<Product>();
	
	try{
		String sql = "select * from product order by seald desc";
		ResultSet rs = DBhelper. executeQuery(sql);
	while(rs.next()){
...
public ArrayList<Product> showallProductByTime(){
	ArrayList<Product> list=new ArrayList<Product>();
	
	try{
		String sql = "select * from product order by publishtime ";
		ResultSet rs = DBhelper. executeQuery(sql);
	while(rs.next()){
